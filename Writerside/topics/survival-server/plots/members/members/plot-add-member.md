...
4. Nun kannst du, wenn du den **Holzblock oben (+)** anklickst, einen Spieler zu deinem ausgewählten Grundstück
   hinzufügen.
...
5. Um die Entfernung zu bestätigen, klicke auf das grüne Glas.\
   Um den ProtectionMode zu verlassen, ohne ein Mitglied zu entfernen, klicke auf das rote Glas.

   ![plot edit member menu](plot-remove-member-confirmation.png) {border-effect="rounded" thumbnail="false" width="480"}
</tab>
</tabs>