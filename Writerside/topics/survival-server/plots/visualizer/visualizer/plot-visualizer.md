...
1. Um den Visualizer zu aktivieren, tippe im Chat den Befehl `/protect` ein.
2. Nun öffnet sich eine Übersicht und du klickst auf das Enderauge.
   ![visualizer](plot-visualizer-select.png) {border-effect="rounded" width="480" thumbnail="false"}
...
| Hellblau | Das Grundstück gehört einem anderen Spieler, du bist jedoch Mitglied dieses Grundstücks | <img src="plot-visualizer-member.png" width="256" thumbnail="true" border-effect="rounded"/>     |

## So deaktivierst du den Visualizer: {id="plot-deactivate-visualizer"}

1. Gib `/protect` im Chat ein und klicke nun im angezeigten Menü auf das **Enderauge**.
