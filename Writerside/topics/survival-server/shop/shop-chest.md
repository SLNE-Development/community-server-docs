...
- 1x Truhe
- 4x Goldbarren
  ![shop-chest-crafting](shop-chest-crafting.png) {border-effect="rounded" thumbnail="false" width="480"}

1. Nachdem du die Shop-Chest platziert hast, kannst du ihr einen deiner [bereits erstellten **Shops**](shop-create.md "%click-more-info%") zuordnen.
