...
Wir informieren euch im [Discord](%dc_link%) unter [%com_updates_channelwie könnt i_display%](%com_updates_channel%), sobald der Server wieder für euch verfügbar ist.
</def>
