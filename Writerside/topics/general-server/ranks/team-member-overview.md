...
| ![Entwickler](developer.png)        | <ul><li>`TheBjoRedCraft`</li><li>`xapfeltortexp`</li></ul>                                                                                                                        |
...
| ![Supporter](support.png)           | <ul><li>`BobbyCar2612`</li><li>`bringeis1`</li><li>`Cookiiieee`</li><li>`_Danilo`</li><li>`Dorlino_`</li><li>`EinePapiertonne`</li><li>`Pingius2031`</li><li>`Timonso`</li></ul> |
| ![Community Manager](community.png) | <ul><li>`Floweryalina`</li><li>`Iloveschnitzel09`</li></ul>                                                                                                                      |
| ![Designer](designer.png)           | <ul><li>`KamiIIe`</li></ul>                                                                                                                                                      |
| ![Builder](builder.png)             | <ul><li>`Kanickelul`</li><li>`PEKK29`</li><li>`Skyfox2`</li><li>`TatatuckRenegade`</li></ul>                                                                                     |
